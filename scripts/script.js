let serverIp = "mc.hypixel.net";
getServerStatus("mc.hypixel.net" , "card-server-status1", ".server-online1");
getServerStatus("armamc.com" , "card-server-status2", ".server-online2");
getServerStatus("jogar.czpvp.com.br" , "card-server-status3", ".server-online3");
getServerStatus("mc.hypixel.net" , "card-server-status4", ".server-online4");
